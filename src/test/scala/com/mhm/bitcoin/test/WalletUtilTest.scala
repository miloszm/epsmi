...
import com.mhm.wallet.WalletUtil.XKeyRawTuple
...
class WalletUtilTest extends FlatSpec {
  ...
  "bip32Serialize for extended key" should "return serialized extended key given elements as in BIP32 serialization format" in {
    ...
    val serXKey = WalletUtil.bip32Serialize(xKeyRawTuple)
  ...
  "bip32Deserialize for extended key" should "return elements as in BIP32 serialization format" in {
    val xKeyRawTuple = WalletUtil.bip32Deserialize("tpubD6NzVbkrYhZ4YVMVzC7wZeRfz3bhqcHvV8M3UiULCfzFtLtp5nwvi6LnBQegrkxYGPkSzXUEvcPEHcKdda8W1YShVBkhFBGkLxjSQ1Nx3cJ")
