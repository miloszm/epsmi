...
class MerkleProofOpsTest extends FlatSpec {
  ...
  "convertCoreToElectrumMerkleProof" should "work also for case 2" in {
    val merkleBlockHex = ""
    val electrumMerkleProof = MerkleProofOps.convertCoreToElectrumMerkleProof(merkleBlockHex)
    ...
    val desiredElectrumMerkle = Array("2c96def4ca1b910fcc73e77c37178ebdc34998880c96bf8875b614889f18bb12", "ab0f2e00f75c25af7cccbd319f862a64fbc61bfb12e181d7114697eb73f18b25", "028dd4a04013a880b20b8eed8de2cd584fecbecd6aa6dc03edc81c1846ba3cee", "c148aedbd228830ccfb5dc5ec8bbda99a2b475b2b391259c2c240f837df2f634", "3d413df4ab9af3cc50fc61a0fe1bf3b840e86dadc512de38a73cbd393c48fad0", "1baf786713f7edc6d84b4421ebcff92651df5988239e5eb8787874ea83e62d7d", "c21c17b69de8718b52e0f8b22747c973737df47fad72a4c420564b02e81e4fe5").map(_.toUpperCase)
    electrumMerkleProof.merkle should contain theSameElementsInOrderAs desiredElectrumMerkle

    val impliedMerkleRoot = HashOps.hashMerkleRoot(desiredElectrumMerkle, electrumMerkleProof.txId, electrumMerkleProof.pos)
  ...
  "deserializeCoreFormatMerkleProof" should "provide correct deserialization" in {
    val hashList = Array("89660C6E8D1EB2CCF67FDA3AC2EF292CC489D6F41E5689CAF373728D5FCD7AC3",
      "151A1E0A44A7484387F9D8E4FAFC2175FF4C92EAB50B4D4D994F40EBFF4FF4A9",
